...
function HeroSection() {
  return (
    <section className="flex items-center justify-center min-h-[90vh] [background-color:var(--color-beige-lino)] p-0 text-left">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center flex-wrap px-4">
        ...
        <div className="inicio-text flex-1 min-w-[400px] max-w-[600px] animate-fadeInSlideUp md:text-center lg:text-left">
          {" "}
          {/* Añadido text-center para móviles */}
          ...
          <a
            href="productos"
            className="inline-block sm:items-start px-8 py-4 [background-color:var(--color-rosa-pastel)] [color:var(--color-blanco)] [font-family:var(--font-poppins)] font-bold text-lg rounded-lg shadow-lg hover:[background-color:var(--color-hover-rosa)] transform hover:-translate-y-1 transition-all duration-300"
          >
